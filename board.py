import pygame
from constants import BLACK, ROWS, LIGHTSLATEBLUE, SQUARE_SIZE, COLS, WHITE, RED, GREY
from piece import Piece

class Board:
    def __init__(self):
        self.board = []
        self.blue_left = self.white_left = 4
    ...
    def move(self, piece, row, col):
        ...
        if row == ROWS-1 and piece.color == WHITE:
             self.remove([piece])
        if row == 0 and piece.color == LIGHTSLATEBLUE:
